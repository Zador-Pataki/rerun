...
pub use re_sdk_types::blueprint::components::ColumnName;
...
pub use re_sdk_types::blueprint::components::Eye3DProjection;
...
pub fn is_valid_blueprint(blueprint: &EntityDb) -> bool {
    validate_component::<AbsoluteTimeRange>(blueprint)
        ...
        && validate_component::<ColumnName>(blueprint)
        ...
        && validate_component::<Eye3DProjection>(blueprint)
